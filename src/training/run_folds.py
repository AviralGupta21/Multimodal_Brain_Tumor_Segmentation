import numpy as np
from train_unet import train_one_fold
...
def run_five_folds(year, start_fold = 0):

    print(f"\n==============================")
    print(f"Running 5-Fold CV for BraTS{year}")
    print(f"==============================")
    ...
    print("\n======================================")
    print(f"FINAL 5-FOLD RESULTS — BraTS{year}")
    print("======================================")

    def print_block(title, summary):
        print(f"\n{title}")

        for metric in ["train_dice", "test_dice",
                       "train_iou", "test_iou",
...
if __name__ == "__main__":
    run_five_folds(2020, start_fold = 0)